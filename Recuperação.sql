...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/06/2025 às 13:41
...
CREATE TABLE `agencias` (
  ...
  `nome_gerente` varchar(45) DEFAULT NULL,
  `localizacao` text DEFAULT NULL,
  `telefone` varchar(10) DEFAULT NULL,
  `data_criacao` date DEFAULT NULL,
  `estado_agencia` text DEFAULT NULL
...
INSERT INTO `agencias` (`numero_agencia`, `cidade_agencia`, `nome_gerente`, `localizacao`, `telefone`, `data_criacao`, `estado_agencia`) VALUES
(1, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd'),
(2, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd'),
(3, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd'),
(4, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd'),
(5, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd'),
(6, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd'),
(7, 'ifgifgfg', 'iudhfdj', 'kdfjkfdj', '8475847', '0000-00-00', 'hdhfhjfd');
...
CREATE TABLE `cartao` (
  ...
  `nome_da_pessoa` varchar(45) DEFAULT NULL,
  `cvv` int(11) DEFAULT NULL,
  `numero_conta` int(11) DEFAULT NULL,
  `validade_cartao` date DEFAULT NULL,
  `compania_cartao` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `cartao` (`numero_cartao`, `tipo_cartao`, `nome_da_pessoa`, `cvv`, `numero_conta`, `validade_cartao`, `compania_cartao`) VALUES
(1, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf'),
(2, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf'),
(3, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf'),
(4, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf'),
(5, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf'),
(6, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf'),
(7, 'ifgifgfg', 'ajkfdhafjhafkjhasf', 4545, NULL, '0000-00-00', 'djhhsfjkdf');

-- --------------------------------------------------------

--
-- Estrutura para tabela `clientes__1_`
--

CREATE TABLE `clientes__1_` (
  `id` int(11) NOT NULL,
  `primeiro_nome` varchar(40) DEFAULT NULL,
  `ultimo_nome` varchar(40) DEFAULT NULL,
  `email` text DEFAULT NULL,
  `genero` text DEFAULT NULL,
  `nome_da_compania` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Despejando dados para a tabela `clientes__1_`
--

INSERT INTO `clientes__1_` (`id`, `primeiro_nome`, `ultimo_nome`, `email`, `genero`, `nome_da_compania`) VALUES
...
(23, 'Dael', 'Roake', 'droakem@cbslocal.com', 'Genderqueer', 'Yodel'),
...
(42, 'Garrett', 'Haddinton', 'ghaddinton15@squarespace.com', 'Genderfluid', 'Trilith'),
...
(68, 'Roch', 'Gallienne', 'rgallienne1v@hud.gov', 'Genderfluid', 'Einti'),
...
(90, 'Elizabet', 'Curwood', 'ecurwood2h@sourceforge.net', 'Genderqueer', 'Eimbee'),
...
(125, 'Cad', 'Livick', 'clivick3g@clickbank.net', 'Genderqueer', 'Oodoo'),
...
(159, 'Andi', 'Whitwam', 'awhitwam4e@china.com.cn', 'Genderqueer', 'Quimm'),
(160, 'Xenos', 'Rittelmeyer', 'xrittelmeyer4f@phpbb.com', 'Genderqueer', 'Blogtags'),
...
(166, 'Hasty', 'Hopkins', 'hhopkins4l@flickr.com', 'Genderqueer', 'Aibox'),
...
(227, 'Abbey', 'Dederick', 'adederick6a@wikispaces.com', 'Genderqueer', 'Topicware'),
...
(237, 'Allister', 'Perton', 'aperton6k@usnews.com', 'Genderqueer', 'Flashdog'),
...
(278, 'Ambur', 'Maskell', 'amaskell7p@gravatar.com', 'Genderfluid', 'Flipstorm'),
...
(359, 'Godfree', 'Schroter', 'gschroter9y@paypal.com', 'Genderfluid', 'Dabvine'),
...
(398, 'Thorndike', 'Timmis', 'ttimmisb1@nih.gov', 'Genderqueer', 'Jabbersphere'),
...
(478, 'Jeanine', 'Beecker', 'jbeeckerd9@cisco.com', 'Genderqueer', 'Devify'),
...
(486, 'Keeley', 'Willson', 'kwillsondh@foxnews.com', 'Genderqueer', 'Trilith'),
(487, 'Blair', 'Kiljan', 'bkiljandi@cnet.com', 'Bigender', 'Feednation'),
(488, 'Tamarah', 'Guitt', 'tguittdj@networkadvertising.org', 'Genderqueer', 'Jabbertype'),
...
(530, 'Reginald', 'Wittrington', 'rwittringtonep@zimbio.com', 'Genderfluid', 'Mita'),
...
(565, 'Callida', 'Vasilchenko', 'cvasilchenkofo@hubpages.com', 'Genderfluid', 'Wordware'),
...
(588, 'Arlena', 'Stiant', 'astiantgb@cam.ac.uk', 'Genderqueer', 'Rhyzio'),
...
INSERT INTO `conta` (`numero_conta`, `id`, `tipo_de_conta`, `nome_conta`, `cpf_cliente`, `data_de_cadastro`, `saldo_cliente`, `extratos`, `transacoes`) VALUES
(15, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj'),
(16, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj'),
(17, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj'),
(18, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj'),
(19, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj'),
(20, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj'),
(21, NULL, 'ajkfdhafjhafkjhasf', 'djhhsfdjhsf', '56456464', '0000-00-00 00:00:00', 84584574.00, 'ifdhdjfhd', 'djkghgjhgj');

-- --------------------------------------------------------

--
-- Estrutura para tabela `estado_agencias`
--

CREATE TABLE `estado_agencias` (
  `id_estado` int(11) NOT NULL,
  `numero_agencia` int(11) DEFAULT NULL,
  `data_criacao` date DEFAULT NULL,
  `funcionamento` text DEFAULT NULL,
  `reparos_terceiros` text DEFAULT NULL,
  `empresa_terceira_seguranca` text DEFAULT NULL,
  `seguro_agencia` varchar(45) DEFAULT NULL,
  `cofres` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Despejando dados para a tabela `estado_agencias`
--

INSERT INTO `estado_agencias` (`id_estado`, `numero_agencia`, `data_criacao`, `funcionamento`, `reparos_terceiros`, `empresa_terceira_seguranca`, `seguro_agencia`, `cofres`) VALUES
(1, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384),
(2, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384),
(3, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384),
(4, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384),
(5, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384),
(6, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384),
(7, 343443, '0000-00-00', 'dfdffd', 'dkfjfjdf', 'dufufyd', '3434', 9384);
...
CREATE TABLE `funcionario` (
  ...
  `horario_atendimento` datetime DEFAULT NULL,
  `genero` text DEFAULT NULL,
  `caixa` text DEFAULT NULL,
...
INSERT INTO `funcionario` (`id_funcionario`, `nome_funcionario`, `cpf_funcionario`, `horario_atendimento`, `genero`, `caixa`, `setor`) VALUES
(1, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Masculino', 'jdfhhfdj', 'hdhfhjfd'),
(2, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Feminino', 'jdfhhfdj', 'hdhfhjfd'),
(3, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Masculino', 'jdfhhfdj', 'hdhfhjfd'),
(4, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Feminino', 'jdfhhfdj', 'hdhfhjfd'),
(5, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Masculino', 'jdfhhfdj', 'hdhfhjfd'),
(6, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Feminino', 'jdfhhfdj', 'hdhfhjfd'),
(7, 'ifgifgfg', '84487487', '0000-00-00 00:00:00', 'Masculino', 'jdfhhfdj', 'hdhfhjfd');

-- --------------------------------------------------------

--
-- Estrutura para tabela `historico_conta`
--

CREATE TABLE `historico_conta` (
  `id_historico` int(11) NOT NULL,
  `numero_conta` int(11) DEFAULT NULL,
  `transacoes` varchar(100) DEFAULT NULL,
  `depositos` varchar(100) DEFAULT NULL,
  `emprestimos` varchar(100) DEFAULT NULL,
  `investimentos` varchar(100) DEFAULT NULL,
  `numero_agencia` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Despejando dados para a tabela `historico_conta`
--

INSERT INTO `historico_conta` (`id_historico`, `numero_conta`, `transacoes`, `depositos`, `emprestimos`, `investimentos`, `numero_agencia`) VALUES
(1, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL),
(2, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL),
(3, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL),
(4, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL),
(5, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL),
(6, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL),
(7, NULL, 'ifgifgfg', 'iudhfdj', '8454', '8475847', NULL);
...
CREATE TABLE `pedido` (
  ...
  `tipo_pedido` text DEFAULT NULL,
  `id_funcionario` int(11) DEFAULT NULL,
  `horario_do_pedido` time DEFAULT NULL,
  `pedido_concluido` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `pedido` (`id_pedido`, `id`, `numero_cartao`, `tipo_pedido`, `id_funcionario`, `horario_do_pedido`, `pedido_concluido`) VALUES
(1, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0),
(2, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0),
(3, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0),
(4, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0),
(5, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0),
(6, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0),
(7, NULL, NULL, 'ifgifgfg', NULL, '00:00:00', 0);
...
CREATE TABLE `setor` (
  ...
  `tipo_setor` text DEFAULT NULL,
  `nome_funcionarios` varchar(45) DEFAULT NULL,
  `horario_de_funcionamento` datetime DEFAULT NULL,
  `local_setor` varchar(45) DEFAULT NULL,
  `funcionarios_ativos` int(11) DEFAULT NULL,
...
INSERT INTO `setor` (`id_setor`, `tipo_setor`, `nome_funcionarios`, `horario_de_funcionamento`, `local_setor`, `funcionarios_ativos`, `numero_de_funcionarios`) VALUES
(1, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434),
(2, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434),
(3, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434),
(4, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434),
(5, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434),
(6, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434),
(7, 'ifgifgfg', 'iudhfdj', '0000-00-00 00:00:00', 'jshdsj', 343, 3434);
...
CREATE TABLE `tipo_transacao` (
  ...
  `id` int(11) DEFAULT NULL,
  `tipo_pedido` text DEFAULT NULL,
  `nome_do_usuario` varchar(45) DEFAULT NULL,
  `possibilidade_de_transacao` tinyint(1) DEFAULT NULL,
  `disponibilidade_de_caixas` int(11) DEFAULT NULL,
  `transacao_efetuada` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tipo_transacao` (`id_transacao`, `id`, `tipo_pedido`, `nome_do_usuario`, `possibilidade_de_transacao`, `disponibilidade_de_caixas`, `transacao_efetuada`) VALUES
(1, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0),
(2, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0),
(3, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0),
(4, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0),
(5, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0),
(6, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0),
(7, NULL, 'ifgifgfg', 'iudhfdj', 0, 8475847, 0);
...
ALTER TABLE `cartao`
  ...
  ADD KEY `numero_conta` (`numero_conta`);

--
-- Índices de tabela `clientes__1_`
--
ALTER TABLE `clientes__1_`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `estado_agencias`
--
ALTER TABLE `estado_agencias`
...
--
-- Índices de tabela `historico_conta`
--
ALTER TABLE `historico_conta`
  ADD PRIMARY KEY (`id_historico`),
  ADD KEY `numero_conta` (`numero_conta`),
  ADD KEY `numero_agencia` (`numero_agencia`);
...
--
ALTER TABLE `agencias`
  MODIFY `numero_agencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `cartao`
--
ALTER TABLE `cartao`
  MODIFY `numero_cartao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `conta`
--
ALTER TABLE `conta`
  MODIFY `numero_conta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de tabela `estado_agencias`
--
ALTER TABLE `estado_agencias`
...
--
-- AUTO_INCREMENT de tabela `historico_conta`
--
ALTER TABLE `historico_conta`
...
--
ALTER TABLE `cartao`
  ADD CONSTRAINT `cartao_ibfk_1` FOREIGN KEY (`numero_conta`) REFERENCES `conta` (`numero_conta`);

--
-- Restrições para tabelas `conta`
--
ALTER TABLE `conta`
  ADD CONSTRAINT `conta_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes__1_` (`id`);

--
-- Restrições para tabelas `historico_conta`
--
ALTER TABLE `historico_conta`
  ADD CONSTRAINT `historico_conta_ibfk_1` FOREIGN KEY (`numero_conta`) REFERENCES `conta` (`numero_conta`),
  ADD CONSTRAINT `historico_conta_ibfk_2` FOREIGN KEY (`numero_agencia`) REFERENCES `agencias` (`numero_agencia`);

--
-- Restrições para tabelas `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes__1_` (`id`),
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`numero_cartao`) REFERENCES `cartao` (`numero_cartao`),
  ADD CONSTRAINT `pedido_ibfk_3` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionario` (`id_funcionario`);

--
-- Restrições para tabelas `tipo_transacao`
--
ALTER TABLE `tipo_transacao`
  ADD CONSTRAINT `tipo_transacao_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes__1_` (`id`);
COMMIT;
