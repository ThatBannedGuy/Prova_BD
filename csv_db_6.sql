...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/06/2025 às 13:59
...
CREATE TABLE `agencias` (
  ...
  `horario_de_funcionamento` varchar(8) DEFAULT NULL,
  `anos_de_servico` int(11) DEFAULT NULL,
...
INSERT INTO `agencias` (`id_agencia`, `nome_agencia`, `cnpj`, `horario_de_funcionamento`, `anos_de_servico`, `id`, `pais_origem`) VALUES
(1, 'jhfjfhajk', '5664555', '00:00', 34, NULL, 'Brasil'),
(2, 'jhfjfhajk', '5664555', '11:11', 34, NULL, 'Estados Unidos'),
(3, 'jhfjfhajk', '5664555', '22:22', 34, NULL, 'Argentina'),
(4, 'jhfjfhajk', '5664555', '33:33', 34, NULL, 'Afeganistão'),
(5, 'jhfjfhajk', '5664555', '44:44', 34, NULL, 'Russia'),
(6, 'jhfjfhajk', '5664555', '55:55', 34, NULL, 'Brasil'),
(7, 'jhfjfhajk', '5664555', '66:66', 34, NULL, 'Brasil');
...
CREATE TABLE `cartao` (
  ...
  `dataVencimento` varchar(6) DEFAULT NULL,
  `numeroConta` varchar(25) DEFAULT NULL,
  `companiaCartao` text DEFAULT NULL,
  `tipoCartao` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `cartao` (`numeroCartao`, `numeroCvv`, `nomeCartao`, `dataVencimento`, `numeroConta`, `companiaCartao`, `tipoCartao`) VALUES
(1, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'black'),
(2, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'white'),
(3, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'black'),
(4, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'white'),
(5, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'black'),
(6, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'white'),
(7, 111, 'ajkfdhafjhafkjhasf', '123265', '564564648455', 'visa', 'black');
...
INSERT INTO `clientes` (`id`, `primeiro_nome`, `sobrenome`, `email`, `genero`, `nome_da_compania`) VALUES
...
CREATE TABLE `conta` (
  ...
  `id` int(11) DEFAULT NULL,
  `nomeConta` varchar(40) DEFAULT NULL,
  `cpfConta` varchar(13) DEFAULT NULL,
  `dataCriacao` date DEFAULT NULL,
  `tipoConta` text DEFAULT NULL,
  `dadosBancarios` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `conta` (`numeroConta`, `id`, `nomeConta`, `cpfConta`, `dataCriacao`, `tipoConta`, `dadosBancarios`) VALUES
(1, 69, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao'),
(2, 90, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao'),
(3, 23, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao'),
(4, 21, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao'),
(5, 25, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao'),
(6, 71, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao'),
(7, 34, 'ldajkfdsjf', '656455522', '0000-00-00', 'jdfhjfdj', 'saodjadjao');
...
CREATE TABLE `funcionarios` (
  ...
  `horario_de_atendimento` time DEFAULT NULL,
  `genero` text DEFAULT NULL,
...
INSERT INTO `funcionarios` (`id_funcionario`, `nome_funcionario`, `cpf`, `horario_de_atendimento`, `genero`, `setor`, `caixa`) VALUES
(1, 'Jonas', '557878784', '00:00:00', 'homem', 'caixas', 0),
(2, 'Maria', '557878784', '00:00:00', 'mulher', 'caixas', 0),
(3, 'Jonas', '557878784', '00:00:00', 'homem', 'caixas', 0),
(4, 'Rose', '557878784', '00:00:00', 'mulher', 'caixas', 0),
(5, 'Jonas', '557878784', '00:00:00', 'homem', 'caixas', 0),
(6, 'Joana', '557878784', '00:00:00', 'mulher', 'caixas', 0),
(7, 'Jonas', '557878784', '00:00:00', 'homem', 'caixas', 0);
...
CREATE TABLE `movimentacao` (
  ...
  `id` int(11) DEFAULT NULL,
  `movimentacao` text DEFAULT NULL,
  `dados_movimentacao` text DEFAULT NULL,
  `horario_movimentacao` time DEFAULT NULL,
  `recibo_movimentacao` text DEFAULT NULL,
...
INSERT INTO `pedido` (`id_pedido`, `id`, `numeroCartao`, `tipoPedido`, `id_funcionario`) VALUES
(15, NULL, NULL, 'saque', NULL),
(16, NULL, NULL, 'deposito', NULL),
(17, NULL, NULL, 'transferencia', NULL),
(18, NULL, NULL, 'saque', NULL),
(19, NULL, NULL, 'emprestimo', NULL),
(20, NULL, NULL, 'saque', NULL),
(21, NULL, NULL, 'saque', NULL);
...
--
-- Restrições para tabelas `agencias`
--
ALTER TABLE `agencias`
  ADD CONSTRAINT `agencias_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes` (`id`);

--
-- Restrições para tabelas `conta`
--
ALTER TABLE `conta`
  ADD CONSTRAINT `conta_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes` (`id`);

--
-- Restrições para tabelas `movimentacao`
--
ALTER TABLE `movimentacao`
  ADD CONSTRAINT `movimentacao_ibfk_1` FOREIGN KEY (`id`) REFERENCES `clientes` (`id`),
  ADD CONSTRAINT `movimentacao_ibfk_2` FOREIGN KEY (`numeroCartao`) REFERENCES `cartao` (`numeroCartao`);
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `pedido_ibfk_3` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionarios` (`id_funcionario`);
COMMIT;
